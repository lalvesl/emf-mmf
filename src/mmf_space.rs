...
use crate::config::{MotorConfig, MotorConfigChanged, STATOR_BORE_RADIUS};
use crate::eletrical::ElectricalState;

pub struct MffSpacePlugin;

impl Plugin for MffSpacePlugin {
...
fn regenerate_vectors(
    ...
    query: Query<Entity, With<MmfSpace>>,
...
fn animate_vectors(
    ...
    mut query: Query<(&MmfSpace, &mut Transform)>,
) {
    if !config.show_vectors {
        return;
    }
